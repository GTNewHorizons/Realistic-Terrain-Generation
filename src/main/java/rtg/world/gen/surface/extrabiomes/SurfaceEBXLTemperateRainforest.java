...
public class SurfaceEBXLTemperateRainforest extends SurfaceBase
{
	...
	public SurfaceEBXLTemperateRainforest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
	{
	...
	public SurfaceEBXLTemperateRainforest(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
