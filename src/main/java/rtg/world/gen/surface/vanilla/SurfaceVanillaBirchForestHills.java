...
public class SurfaceVanillaBirchForestHills extends SurfaceBase
{
    ...
    public SurfaceVanillaBirchForestHills(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff,
        float stoneHeight, float stoneStrength, float clayCliff, Block mix, byte mixByte, float mixSize)
    {
        ...
        mixBlockMeta = this.getConfigBlockMeta(config, BiomeConfigVanillaBirchForestHills.surfaceMixBlockMetaId, mixByte);
        mixHeight = mixSize;
    }
