...
public class SurfaceEBFloweryArchipelago extends SurfaceEBBase
{
    ...
    public SurfaceEBFloweryArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
