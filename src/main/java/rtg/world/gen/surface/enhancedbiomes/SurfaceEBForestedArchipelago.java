...
public class SurfaceEBForestedArchipelago extends SurfaceEBBase
{
    ...
    public SurfaceEBForestedArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
