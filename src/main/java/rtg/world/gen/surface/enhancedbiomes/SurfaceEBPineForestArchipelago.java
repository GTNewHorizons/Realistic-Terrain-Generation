...
public class SurfaceEBPineForestArchipelago extends SurfaceEBBase
{
    ...
    public SurfaceEBPineForestArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
        ...
        for (int k = 255; k > -1; k--)
        {
            ...
            else if (b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    ...
                    metadata[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(EBAPI.DOLOMITE, hcStoneMeta(world, i, j, x, y, k));
                }
