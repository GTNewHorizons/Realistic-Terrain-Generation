...
public class SurfaceEBWoodlandField extends SurfaceEBBase
{
    ...
    public SurfaceEBWoodlandField(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
        ...
        for (int k = 255; k > -1; k--)
        {
            ...
            else if (b == Blocks.stone)
            {
                ...
                if (shouldReplaceStone()) {
                    blocks[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(hcStone(world, i, j, x, y, k), hcStone(world, i, j, x, y, k));
                    metadata[(y * 16 + x) * 256 + k] = EBAPI.ebStonify(hcStoneMeta(world, i, j, x, y, k), hcStoneMeta(world, i, j, x, y, k));
                }
