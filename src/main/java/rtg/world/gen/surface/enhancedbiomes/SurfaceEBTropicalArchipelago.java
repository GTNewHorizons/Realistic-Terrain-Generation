...
public class SurfaceEBTropicalArchipelago extends SurfaceEBBase
{
    ...
    public SurfaceEBTropicalArchipelago(BiomeConfig config, Block top, byte topByte, Block filler, byte fillerByte, Block mixTop, byte mixTopByte, Block mixFiller,
