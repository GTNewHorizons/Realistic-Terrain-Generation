...
public class SurfaceCCLuminousCliffs extends SurfaceBase
{
    ...
    public SurfaceCCLuminousCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
    {
    ...
    public SurfaceCCLuminousCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
    {
