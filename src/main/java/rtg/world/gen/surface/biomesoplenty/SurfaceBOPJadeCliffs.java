...
public class SurfaceBOPJadeCliffs extends SurfaceBase
{
	...
	public SurfaceBOPJadeCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
	{
	...
	public SurfaceBOPJadeCliffs(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
