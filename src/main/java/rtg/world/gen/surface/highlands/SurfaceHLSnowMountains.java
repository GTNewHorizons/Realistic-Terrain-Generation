...
public class SurfaceHLSnowMountains extends SurfaceBase
{
	...
	public SurfaceHLSnowMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
	{
	...
	public SurfaceHLSnowMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
