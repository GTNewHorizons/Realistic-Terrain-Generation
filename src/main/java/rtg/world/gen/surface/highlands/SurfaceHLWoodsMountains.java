...
public class SurfaceHLWoodsMountains extends SurfaceBase
{
    ...
    public SurfaceHLWoodsMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff)
    {
    ...
    public SurfaceHLWoodsMountains(BiomeConfig config, Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
    {
