...
public class WorldGenTreeFir extends WorldGenHighlandsTreeBase {
     ...
     */
    public WorldGenTreeFir(int lmd, int wmd, Block wb, Block lb, int minH, int maxH, boolean notify,
        boolean thickTrunk) {
    ...
    public boolean generate(World world, Random random, int locX, int locY, int locZ) {
        ...
        if (!isLegalTreePosition(world, locX, locY, locZ) && world.getBlock(locX, locY - 1, locZ) != Blocks.snow)
            return false;
