...
public class WorldGenTreeIronwood extends WorldGenHighlandsTreeBase {
     ...
     * @param wb     wood block
     * @param lb     leaf block
     * @param minH   in an Ironwood tree, max height to generate the thick trunk
     * @param maxH   in an Ironwood tree, height of the crown
     * @param notify whether or not to notify blocks of the tree being grown.
     *               Generally false for world generation, true for saplings.
     */
    public WorldGenTreeIronwood(int lmd, int wmd, Block wb, Block lb, int minH, int maxH, boolean notify) {
    ...
    public WorldGenTreeIronwood(int minH, int maxH, boolean notify) {
        this(0, 0, HighlandsBlocks.ironWood, HighlandsBlocks.ironwoodLeaves, minH, maxH, notify);
    ...
    public boolean generate(World world, Random random, int locX, int locY, int locZ) {
        ...
        if (!isCubeClear(locX, locY + 2, locZ, 2, 6)) {
            // this.worldObj = null;
            // return false;
        }

        // generates the leaf layer
        if (!new WorldGenIronwoodCrown(false, true, 0, 0, 1, maxHeight).generate(world, random, locX, locY, locZ)) {
            Logs.log(Level.INFO, "[Highlands] failed to grow IronWood tree");
            return false;
        }
        // generates the trunk
    ...
    private class WorldGenIronwoodCrown extends WorldGenerator {
        ...
        /**
         * Contains three sets of two values that provide complimentary indices for a given 'major' index - 1 and 2 for
         * 0, 0
         * and 2 for 1, and 0 and 1 for 2.
         */
        final byte[] otherCoordPairs = new byte[] { (byte) 2, (byte) 0, (byte) 0, (byte) 1, (byte) 2, (byte) 1 };
        ...
        /**
         * Currently always 1, can be set to 2 in the class constructor to generate a double-sized tree trunk for big
         * trees.
         */
        int trunkSize = 1;
        ...
        public WorldGenIronwoodCrown(boolean par1, boolean placeLeaves, int wmd, int lmd, int trunkDiameter,
            int treeHeightLim) {
            super(par1);
            ...
            woodID = Highlands.vanillaBlocksFlag ? Blocks.log : HighlandsBlocks.ironWood;
            leavesID = Highlands.vanillaBlocksFlag ? Blocks.leaves : HighlandsBlocks.ironwoodLeaves;
        }
            ...
            for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
                ...
                while (var13 <= var7) {
                    ...
                    if (var15 > (double) (par4 * par4)) {
                        ...
                        if (!this.worldObj.isAirBlock(var11[0], var11[1], var11[2])
                            && !var14.isLeaves(worldObj, var11[0], var11[1], var11[2])) {
                            ++var13;
                        } else {
                            if (hasLeaves) this.setBlockAndNotifyAdequately(
                                this.worldObj,
                                var11[0],
                                var11[1],
                                var11[2],
        ...
        void generateLeafNode(int par1, int par2, int par3) {
            ...
            for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
                ...
                this.genTreeLayer(par1, var4, par3, var6, (byte) 1, this.leavesID);
            }
        }
        ...
        void generateTrunk() {
            ...
            this.placeBlockLine(var5, var6, this.woodID);
        ...
        void generateLeafNodeBases() {
            ...
            for (int[] var3 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; var1 < var2; ++var1) {
                ...
                if (this.leafNodeNeedsBase(var6)) {
                    this.placeBlockLine(var3, var5, this.woodID);
                }
            }
        }

        /**
         * Checks a line of blocks in the world from the first coordinate to triplet to the second, returning the
         * distance
        ...
        int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
            ...
            if (var3[var5] == 0) {
                ...
                for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                    ...
                    if (!this.worldObj.isAirBlock(var13[0], var13[1], var13[2])
                        && !var16.isLeaves(worldObj, var13[0], var13[1], var13[2])) {
                        break;
                    }
                }
        ...
        /**
         * Returns a boolean indicating whether or not the current location for the tree, spanning basePos to to the
         * height
         * limit, is valid.
         */
