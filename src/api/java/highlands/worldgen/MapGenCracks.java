...
public class MapGenCracks extends MapGenBase {
    ...
    protected void func_151540_a(long seed, int chunkX, int chunkZ, Block[] blockArray, double x, double y, double z,
        float p_151540_12_, float p_151540_13_, float p_151540_14_, int p_151540_15_, int p_151540_16_, double height) {
        ...
        for (; p_151540_15_ < p_151540_16_; ++p_151540_15_) {
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (x >= d4 - 16.0D - d12 * 2.0D && z >= d5 - 16.0D - d12 * 2.0D
                    && x <= d4 + 16.0D + d12 * 2.0D
                    && z <= d5 + 16.0D + d12 * 2.0D) {
