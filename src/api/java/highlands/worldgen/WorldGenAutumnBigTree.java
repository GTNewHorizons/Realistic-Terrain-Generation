...
public class WorldGenAutumnBigTree extends WorldGenAbstractTree {
    ...
    public WorldGenAutumnBigTree(boolean par1, boolean placeLeaves, int wmd, int lmd, Block log,
        Block autumnYellowLeaves, int trunkDiameter, int treeHeightLim) {
        super(par1);
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte) 1, leafID);
        }
    }
