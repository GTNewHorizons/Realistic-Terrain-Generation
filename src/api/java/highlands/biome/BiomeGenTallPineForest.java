...
public class BiomeGenTallPineForest extends BiomeGenBaseHighlands {
    ...
    public WorldGenAbstractTree func_150567_a(Random par1Random) {
        return (WorldGenAbstractTree) (par1Random.nextInt(8) == 0 ? new WorldGenTaiga1()
            : par1Random.nextInt(3) == 0 ? new WorldGenHighlandsShrub(0, 0)
                : par1Random.nextInt(4) == 0 ? new WorldGenTreeFir(15, 10, false, true)
                    : new WorldGenTreeFir(15, 10, false, false));
    }
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        ((BiomeDecoratorHighlands) this.theBiomeDecorator)
            .genOreHighlands(world, random, x, z, 20, this.theBiomeDecorator.coalGen, 0, 128);
    }
}
