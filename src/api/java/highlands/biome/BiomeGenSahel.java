...
public class BiomeGenSahel extends BiomeGenBaseHighlands {
    ...
    public WorldGenAbstractTree func_150567_a(Random par1Random) {
        return (WorldGenAbstractTree) (par1Random.nextInt(6) != 0 ? new WorldGenSavannaTree(false)
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        ((BiomeDecoratorHighlands) this.theBiomeDecorator).genOreHighlandsNoCheck(
            world,
            random,
            x,
            z,
            2,
            ((BiomeDecoratorHighlands) this.theBiomeDecorator).HLdirt,
            62,
            80);
