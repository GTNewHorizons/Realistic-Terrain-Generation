...
public class BiomeGenWoodsMountains extends BiomeGenBaseHighlands {
    ...
    public WorldGenAbstractTree func_150567_a(Random par1Random) {
        ...
        switch (a) {
            ...
            case 2:
                return (WorldGenAbstractTree) this.worldGeneratorTrees;
            case 3:
                return (WorldGenAbstractTree) this.worldGeneratorBigTree;
            case 4:
                return (WorldGenAbstractTree) new WorldGenHighlandsBigTree(false, true, 2, 2, 1, 0);
            case 5:
                return (WorldGenAbstractTree) new WorldGenHighlandsBigTree(false, true, 0, 0, 2, 16); // bad ??? 20
                                                                                                      // height
            default:
                return (WorldGenAbstractTree) this.worldGeneratorTrees;
        }
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        ((BiomeDecoratorHighlands) this.theBiomeDecorator)
            .genOreHighlands(world, random, x, z, 1, this.theBiomeDecorator.diamondGen, 0, 16);
        ((BiomeDecoratorHighlands) this.theBiomeDecorator).genOreHighlands(
            ...
            z,
            20,
            ((BiomeDecoratorHighlands) this.theBiomeDecorator).HLwater,
            0,
            128);
    }
}
