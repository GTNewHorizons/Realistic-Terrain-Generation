...
public class BiomeGenRainforest extends BiomeGenBaseHighlands {
    ...
    public WorldGenAbstractTree func_150567_a(Random par1Random) {
        if (par1Random.nextInt(3) == 0) return (WorldGenAbstractTree) new WorldGenTreeAsh(16, 8, false);
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random par1Random) {
        return par1Random.nextInt(2) == 0 ? new WorldGenTallGrass(Blocks.tallgrass, 1)
