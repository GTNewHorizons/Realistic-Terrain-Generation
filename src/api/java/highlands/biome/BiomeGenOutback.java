...
public class BiomeGenOutback extends BiomeGenBaseHighlands {
    ...
    public void decorate(World world, Random random, int x, int z) {
        ...
        ((BiomeDecoratorHighlands) this.theBiomeDecorator)
            .genOreHighlands(world, random, x, z, 10, ((BiomeDecoratorHighlands) this.theBiomeDecorator).HLsand, 0, 64);
         ...
         * int topY = 128;
         * int var11;
         * for (boolean var6 = false; ((var11 = par1World.getBlockId(par3+i, topY, par4+j)) == 0 || var11 ==
         * Block.leaves.blockID) && topY > 0; --topY)
         * {
         * ;
         * }
    ...
    public void genTerrainBlocks(World world, Random random, Block[] blocksArray, byte[] blocksMetadataArray,
