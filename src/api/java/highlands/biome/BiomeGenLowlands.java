...
public class BiomeGenLowlands extends BiomeGenBaseHighlands {
    ...
    public WorldGenAbstractTree func_150567_a(Random par1Random) {
        return (WorldGenAbstractTree) (par1Random.nextInt(8) == 0 ? new WorldGenHighlandsShrub(0, 0)
            : par1Random.nextInt(4) != 0 ? new WorldGenTrees(false, 3 + par1Random.nextInt(3), 0, 0, false)
                : new WorldGenTreeFir(10, 5, false, false));
    }
