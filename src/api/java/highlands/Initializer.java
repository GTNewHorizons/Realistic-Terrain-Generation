...
public class Initializer {
    ...
    public static void constructBlocks() {
        ...
        // Planks and stairs
        HighlandsBlocks.hlplanks = new BlockHighlandsPlanks().setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodPlanks");
        GameRegistry.registerBlock(HighlandsBlocks.hlplanks, ItemBlockPlanks.class, "hl_woodPlanks");

        HighlandsBlocks.hlplankstairs0 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 0).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodStairs0");
        registerBlock(HighlandsBlocks.hlplankstairs0, "Yellow Wood Stairs");

        HighlandsBlocks.hlplankstairs1 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 1).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodStairs1");
        registerBlock(HighlandsBlocks.hlplankstairs1, "White Wood Stairs");

        HighlandsBlocks.hlplankstairs2 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 2).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodStairs2");
        registerBlock(HighlandsBlocks.hlplankstairs2, "Red Wood Stairs");

        HighlandsBlocks.hlplankstairs3 = new BlockHighlandsStairs(HighlandsBlocks.hlplanks, 3).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodStairs3");
        registerBlock(HighlandsBlocks.hlplankstairs3, "Grey Wood Stairs");

        HighlandsBlocks.hlplankhalfdouble = new BlockHLPlankSlab(true, HighlandsBlocks.hlplanks).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodSlabDouble");
        GameRegistry.registerBlock(HighlandsBlocks.hlplankhalfdouble, ItemSlabPlanks.class, "hl_woodDoubleSlab");
        HighlandsBlocks.hlplankhalf = new BlockHLPlankSlab(false, HighlandsBlocks.hlplanks).setHardness(2.0F)
            .setResistance(5.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("hl_woodSlab");
        GameRegistry.registerBlock(HighlandsBlocks.hlplankhalf, ItemSlabPlanks.class, "hl_woodSlab");

        HighlandsBlocks.saplings = new Block[] { HighlandsBlocks.firSapling, HighlandsBlocks.acaciaSapling,
            HighlandsBlocks.redwoodSapling, HighlandsBlocks.poplarSapling, HighlandsBlocks.canopySapling,
            HighlandsBlocks.greatOakSapling, HighlandsBlocks.beechSapling, HighlandsBlocks.deadSapling,
            HighlandsBlocks.evergreenBushSapling, HighlandsBlocks.deciduousBushSapling, HighlandsBlocks.palmSapling,
            HighlandsBlocks.ironwoodSapling, HighlandsBlocks.mangroveSapling, HighlandsBlocks.ashSapling,
            HighlandsBlocks.autumnYellowSapling, HighlandsBlocks.autumnOrangeSapling,

            HighlandsBlocks.japaneseMapleSapling, };

        HighlandsBlocks.leaves = new Block[] { HighlandsBlocks.firLeaves, HighlandsBlocks.acaciaLeaves,
            HighlandsBlocks.redwoodLeaves, HighlandsBlocks.poplarLeaves, HighlandsBlocks.canopyLeaves,
            HighlandsBlocks.palmLeaves, HighlandsBlocks.ironwoodLeaves, HighlandsBlocks.mangroveLeaves,
            HighlandsBlocks.ashLeaves, HighlandsBlocks.autumnYellowLeaves, HighlandsBlocks.autumnOrangeLeaves,

            HighlandsBlocks.japaneseMapleLeaves, };

        HighlandsBlocks.logs = new Block[] { HighlandsBlocks.firWood, HighlandsBlocks.acaciaWood,
            HighlandsBlocks.redwoodWood, HighlandsBlocks.poplarWood, HighlandsBlocks.canopyWood,
            HighlandsBlocks.palmWood, HighlandsBlocks.ironWood, HighlandsBlocks.mangroveWood, HighlandsBlocks.ashWood,

            HighlandsBlocks.japaneseMapleWood, };

        HighlandsBlocks.plants = new Block[] { HighlandsBlocks.blueFlower, HighlandsBlocks.leafyFern,
            HighlandsBlocks.lavender, HighlandsBlocks.cattail, HighlandsBlocks.whiteFlower,
            HighlandsBlocks.raspberryBush, HighlandsBlocks.blueberryBush, HighlandsBlocks.cotton,
            HighlandsBlocks.thornbush, };

        HighlandsBlocks.planks = new Block[] { HighlandsBlocks.hlplanks, HighlandsBlocks.hlplankstairs0,
            HighlandsBlocks.hlplankstairs1, HighlandsBlocks.hlplankstairs2, HighlandsBlocks.hlplankstairs3,
            HighlandsBlocks.hlplankhalf, HighlandsBlocks.hlplankhalfdouble, };
    ...
    public static void constructBiomes() {
        ...
        if (Config.autumnForestID > -1) {
            HighlandsBiomes.autumnForest = new BiomeGenAutumnForest(Config.autumnForestID)
                .setBiomeName(biomePrefix + "Autumn Forest");
        ...
        if (Config.birchHillsID > -1) {
            HighlandsBiomes.birchHills = new BiomeGenBirchHills(Config.birchHillsID)
                .setBiomeName(biomePrefix + "Birch Hills");
        ...
        if (Config.desertMountainsID > -1) {
            HighlandsBiomes.desertMountains = new BiomeGenDesertMountains(Config.desertMountainsID)
                .setBiomeName(biomePrefix + "Desert Mountains");
        ...
        // HighlandsBiomes.everglades = new
        // BiomeGenEverglades(Config.evergladesID).setBiomeName(biomePrefix+"Everglades");
        // HighlandsBiomes.biomesForHighlands.add(HighlandsBiomes.everglades);
        // }
        if (Config.flyingMountainsID > -1) {
            HighlandsBiomes.flyingMountains = new BiomeGenFlyingMountains(Config.flyingMountainsID)
                .setBiomeName(biomePrefix + "Flying Mountains");
        ...
        if (Config.highlandsbID > -1) {
            HighlandsBiomes.highlandsb = new BiomeGenHighlands(Config.highlandsbID)
                .setBiomeName(biomePrefix + "Highlands");
        ...
        if (Config.pinelandsID > -1) {
            HighlandsBiomes.pinelands = new BiomeGenPinelands(Config.pinelandsID)
                .setBiomeName(biomePrefix + "Pinelands");
            HighlandsBiomes.biomesForHighlands.add(HighlandsBiomes.pinelands);
        }
        if (Config.rainforestID > -1) {
            HighlandsBiomes.rainforest = new BiomeGenRainforest(Config.rainforestID)
                .setBiomeName(biomePrefix + "Rainforest");
            HighlandsBiomes.biomesForHighlands.add(HighlandsBiomes.rainforest);
        }
        if (Config.redwoodForestID > -1) {
            HighlandsBiomes.redwoodForest = new BiomeGenRedwoodForest(Config.redwoodForestID)
                .setBiomeName(biomePrefix + "Redwood Forest");
            HighlandsBiomes.biomesForHighlands.add(HighlandsBiomes.redwoodForest);
        }
        if (Config.rockMountainsID > -1) {
            HighlandsBiomes.rockMountains = new BiomeGenRockMountains(Config.rockMountainsID)
                .setBiomeName(biomePrefix + "Rock Mountains");
        ...
        if (Config.snowMountainsID > -1) {
            HighlandsBiomes.snowMountains = new BiomeGenSnowMountains(Config.snowMountainsID)
                .setBiomeName(biomePrefix + "Snow Mountains");
        ...
        if (Config.tallPineForestID > -1) {
            HighlandsBiomes.tallPineForest = new BiomeGenTallPineForest(Config.tallPineForestID)
                .setBiomeName(biomePrefix + "Tall Pine Forest");
        ...
        if (Config.tropicalIslandsID > -1) {
            HighlandsBiomes.tropicalIslands = new BiomeGenTropicalIslands(Config.tropicalIslandsID)
                .setBiomeName(biomePrefix + "Tropical Islands");
        ...
        if (Config.woodlandsID > -1) {
            HighlandsBiomes.woodlands = new BiomeGenWoodlands(Config.woodlandsID)
                .setBiomeName(biomePrefix + "Woodlands");
            HighlandsBiomes.biomesForHighlands.add(HighlandsBiomes.woodlands);

        }
        if (Config.woodlandMountainsID > -1) {
            HighlandsBiomes.woodsMountains = new BiomeGenWoodsMountains(Config.woodlandMountainsID)
                .setBiomeName(biomePrefix + "Woodland Mountains");
        ...
        if (Config.desertIslandID > -1) {
            HighlandsBiomes.desertIsland = new BiomeGenDesertIsland(Config.desertIslandID)
                .setBiomeName(biomePrefix + "Desert Island")
                .setHeight(desertIsle);
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.desertIsland);
        }
        if (Config.forestIslandID > -1) {
            HighlandsBiomes.forestIsland = new BiomeGenWoodlands(Config.forestIslandID)
                .setBiomeName(biomePrefix + "Forest Island")
                .setHeight(woodIsle);
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.forestIsland);
        }
        if (Config.jungleIslandID > -1) {
            HighlandsBiomes.jungleIsland = new BiomeGenJungle(Config.jungleIslandID, false)
                .setBiomeName(biomePrefix + "Jungle Island")
                .setHeight(woodIsle)
                .setTemperatureRainfall(1.0F, 1.2F);
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.jungleIsland);
        }
        if (Config.volcanoIslandID > -1) {
            HighlandsBiomes.volcanoIsland = new BiomeGenVolcanoIsland(Config.volcanoIslandID)
                .setBiomeName(biomePrefix + "Volcano Island");
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.volcanoIsland);
        }
        if (Config.snowIslandID > -1) {
            HighlandsBiomes.snowIsland = new BiomeGenTaiga(Config.snowIslandID, 3)
                .setBiomeName(biomePrefix + "Snow Island")
                .setHeight(woodIsle)
                .setTemperatureRainfall(0.0F, 0.6F);
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.snowIsland);
        }
        if (Config.rockIslandID > -1) {
            HighlandsBiomes.rockIsland = new BiomeGenRockIsland(Config.rockIslandID)
                .setBiomeName(biomePrefix + "Rock Island");
            HighlandsBiomes.subBiomes.add(HighlandsBiomes.rockIsland);
        }
        if (Config.windyIslandID > -1) {
            HighlandsBiomes.windyIsland = new BiomeGenOcean(Config.windyIslandID)
                .setBiomeName(biomePrefix + "Windy Island")
                .setHeight(windIsle);
        ...
        if (Config.shrublandID > -1) {
            HighlandsBiomes.shrubland = new BiomeGenShrubland(Config.shrublandID)
                .setBiomeName(biomePrefix + "Shrubland");
        ...
        if (Config.extremeHillsGenerate.getBoolean(true))
            HighlandsBiomes.biomesForHighlands.add(BiomeGenBase.extremeHills);
    ...
    public static void initRecipes() {
        ...
        if (HighlandsBlocks.firSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.firSapling),
        ...
        if (HighlandsBlocks.acaciaSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.acaciaSapling),
        ...
        if (HighlandsBlocks.poplarSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.poplarSapling),
        ...
        if (HighlandsBlocks.redwoodSapling != null && HighlandsBlocks.firSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.redwoodSapling),
                new ItemStack(Items.dye, 1, 15),
                new ItemStack(HighlandsBlocks.firSapling, 1, 0),
                new ItemStack(Blocks.log, 1, 0));
        }
        // Canopy Tree Sapling
        if (HighlandsBlocks.canopySapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.canopySapling),
                new ItemStack(Blocks.sapling, 1, 3),
        ...
        if (HighlandsBlocks.greatOakSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.greatOakSapling),
        ...
        if (HighlandsBlocks.beechSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.beechSapling),
                new ItemStack(Blocks.sapling, 1, 2),
        ...
        if (HighlandsBlocks.evergreenBushSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.evergreenBushSapling, 2, 0),
                new ItemStack(Blocks.sapling, 1, 1),
        ...
        if (HighlandsBlocks.deciduousBushSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.deciduousBushSapling, 2, 0),
                new ItemStack(Blocks.sapling, 1, 0),
                new ItemStack(Items.stick));
        }
        // Palm Sapling
        if (HighlandsBlocks.palmSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.palmSapling),
                new ItemStack(Blocks.sapling, 1, 3),
                new ItemStack(Blocks.log, 1, 2));
        }
        // Dead Tree Sapling
        ...
        // Ironwood Sapling
        if (HighlandsBlocks.ironwoodSapling != null && HighlandsBlocks.beechSapling != null
            && HighlandsBlocks.greatOakSapling != null
            && HighlandsBlocks.redwoodSapling != null
            && HighlandsBlocks.canopySapling != null) {
            registerBlock(HighlandsBlocks.ironwoodSapling, "Ironwood Sapling");
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.ironwoodSapling),
                new ItemStack(HighlandsBlocks.redwoodSapling, 1, 0),
                new ItemStack(HighlandsBlocks.greatOakSapling, 1, 0),
                new ItemStack(HighlandsBlocks.canopySapling, 1, 0),
                new ItemStack(HighlandsBlocks.beechSapling, 1, 0),
        ...
        if (HighlandsBlocks.mangroveSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.mangroveSapling),
                new ItemStack(Blocks.sapling, 1, 2),
                new ItemStack(Blocks.log, 1, 3));
        }
        // Ash Sapling
        if (HighlandsBlocks.ashSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.ashSapling),
                new ItemStack(HighlandsBlocks.greatOakSapling, 1, 0),
                new ItemStack(Blocks.log, 1, 3));
        }
        // Orange Sapling
        if (HighlandsBlocks.autumnOrangeSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.autumnOrangeSapling),
                new ItemStack(Blocks.sapling, 1, 0),
        ...
        if (HighlandsBlocks.autumnYellowSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.autumnYellowSapling),
                new ItemStack(Blocks.sapling, 1, 0),
        ...
        if (HighlandsBlocks.japaneseMapleSapling != null) {
            ...
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.japaneseMapleSapling),
                new ItemStack(Blocks.sapling, 1, 0),
                new ItemStack(Items.dye, 1, 15));
        }
        ...
        if (HighlandsBlocks.firWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.firWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry
                .addShapelessRecipe(new ItemStack(Blocks.planks, 4, 1), new ItemStack(HighlandsBlocks.firWood, 1, 0));
        ...
        if (HighlandsBlocks.acaciaWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.acaciaWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 0),
                new ItemStack(HighlandsBlocks.acaciaWood, 1, 0));
        ...
        if (HighlandsBlocks.poplarWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.poplarWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 1),
                new ItemStack(HighlandsBlocks.poplarWood, 1, 0));
        ...
        if (HighlandsBlocks.redwoodWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.redwoodWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 2),
                new ItemStack(HighlandsBlocks.redwoodWood, 1, 0));
        ...
        if (HighlandsBlocks.canopyWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.canopyWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(Blocks.planks, 4, 2),
                new ItemStack(HighlandsBlocks.canopyWood, 1, 0));
        ...
        if (HighlandsBlocks.mangroveWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.mangroveWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 3),
                new ItemStack(HighlandsBlocks.mangroveWood, 1, 0));
        ...
        if (HighlandsBlocks.ashWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.ashWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry
                .addShapelessRecipe(new ItemStack(Blocks.planks, 4, 0), new ItemStack(HighlandsBlocks.ashWood, 1, 0));
        ...
        if (HighlandsBlocks.palmWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.palmWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry
                .addShapelessRecipe(new ItemStack(Blocks.planks, 4, 0), new ItemStack(HighlandsBlocks.palmWood, 1, 0));
        ...
        if (HighlandsBlocks.ironWood != null) {
            ...
            OreDictionary
                .registerOre("logWood", new ItemStack(HighlandsBlocks.ironWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 3),
                new ItemStack(HighlandsBlocks.ironWood, 1, 0));
        ...
        if (HighlandsBlocks.japaneseMapleWood != null) {
            ...
            OreDictionary.registerOre(
                "logWood",
                new ItemStack(HighlandsBlocks.japaneseMapleWood, 1, OreDictionary.WILDCARD_VALUE));
            GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 4, 3),
                new ItemStack(HighlandsBlocks.japaneseMapleWood, 1, 0));
        ...
        if (HighlandsBlocks.hlplanks != null) {
            OreDictionary
                .registerOre("plankWood", new ItemStack(HighlandsBlocks.hlplanks, 1, OreDictionary.WILDCARD_VALUE));
        }

        // Planks - stairs
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankstairs0 != null) {
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankstairs0, 4),
                new Object[] { "B  ", "BB ", "BBB", Character.valueOf('B'),
                    new ItemStack(HighlandsBlocks.hlplanks, 1, 0) });
        }
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankstairs1 != null) {
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankstairs1, 4),
                new Object[] { "B  ", "BB ", "BBB", Character.valueOf('B'),
                    new ItemStack(HighlandsBlocks.hlplanks, 1, 1) });
        }
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankstairs2 != null) {
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankstairs2, 4),
                new Object[] { "B  ", "BB ", "BBB", Character.valueOf('B'),
                    new ItemStack(HighlandsBlocks.hlplanks, 1, 2) });
        }
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankstairs3 != null) {
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankstairs3, 4),
                new Object[] { "B  ", "BB ", "BBB", Character.valueOf('B'),
                    new ItemStack(HighlandsBlocks.hlplanks, 1, 3) });
        }

        // Planks - half blocks
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankhalf != null) {
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankhalf, 6, 0),
                new Object[] { "BBB", Character.valueOf('B'), new ItemStack(HighlandsBlocks.hlplanks, 1, 0) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankhalf, 6, 1),
                new Object[] { "BBB", Character.valueOf('B'), new ItemStack(HighlandsBlocks.hlplanks, 1, 1) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankhalf, 6, 2),
                new Object[] { "BBB", Character.valueOf('B'), new ItemStack(HighlandsBlocks.hlplanks, 1, 2) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplankhalf, 6, 3),
                new Object[] { "BBB", Character.valueOf('B'), new ItemStack(HighlandsBlocks.hlplanks, 1, 3) });

            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 1, 0),
                new Object[] { "P", "P", Character.valueOf('P'), new ItemStack(HighlandsBlocks.hlplankhalf, 1, 0) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 1, 1),
                new Object[] { "P", "P", Character.valueOf('P'), new ItemStack(HighlandsBlocks.hlplankhalf, 1, 1) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 1, 2),
                new Object[] { "P", "P", Character.valueOf('P'), new ItemStack(HighlandsBlocks.hlplankhalf, 1, 2) });
            GameRegistry.addRecipe(
                new ItemStack(HighlandsBlocks.hlplanks, 1, 3),
                new Object[] { "P", "P", Character.valueOf('P'), new ItemStack(HighlandsBlocks.hlplankhalf, 1, 3) });
        }
        // Planks - double half blocks
        if (HighlandsBlocks.hlplanks != null && HighlandsBlocks.hlplankhalfdouble != null) {
            // GameRegistry.registerBlock(HighlandsBlocks.hlplankhalfdouble, ItemBlockMetadata.class,
            // "hl_woodDoubleSlab");
        }
        ...
        if (HighlandsBlocks.blueFlower != null) {
            ...
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.dye, 1, 6), new ItemStack(HighlandsBlocks.blueFlower, 1, 0));
        }
        if (HighlandsBlocks.leafyFern != null) {
            registerBlock(HighlandsBlocks.leafyFern, "Leafy Fern");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.dye, 1, 10), new ItemStack(HighlandsBlocks.leafyFern, 1, 0));
        }
        if (HighlandsBlocks.whiteFlower != null) {
            registerBlock(HighlandsBlocks.whiteFlower, "White Flower");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.dye, 1, 7), new ItemStack(HighlandsBlocks.whiteFlower, 1, 0));
        }
        if (HighlandsBlocks.cattail != null) {
            registerBlock(HighlandsBlocks.cattail, "Cattail");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.paper, 1, 0), new ItemStack(HighlandsBlocks.cattail, 1, 0));
        }
        if (HighlandsBlocks.lavender != null) {
            registerBlock(HighlandsBlocks.lavender, "Lavender");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.dye, 1, 5), new ItemStack(HighlandsBlocks.lavender, 1, 0));
        }
        if (HighlandsBlocks.raspberryBush != null) {
            registerBlock(HighlandsBlocks.raspberryBush, "Raspberry Bush");
            if (HighlandsBlocks.berries != null) GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.berries, 1, 0),
                new ItemStack(HighlandsBlocks.raspberryBush, 1, 0));
        }
        if (HighlandsBlocks.blueberryBush != null) {
            registerBlock(HighlandsBlocks.blueberryBush, "Blueberry Bush");
            if (HighlandsBlocks.berries != null) GameRegistry.addShapelessRecipe(
                new ItemStack(HighlandsBlocks.berries, 1, 0),
                new ItemStack(HighlandsBlocks.blueberryBush, 1, 0));
        }
        if (HighlandsBlocks.thornbush != null) {
            registerBlock(HighlandsBlocks.thornbush, "Thornbush");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.stick, 2, 0), new ItemStack(HighlandsBlocks.thornbush, 1, 0));
        }
        if (HighlandsBlocks.cotton != null) {
            registerBlock(HighlandsBlocks.cotton, "Cotton Plant");
            GameRegistry
                .addShapelessRecipe(new ItemStack(Items.string, 1, 0), new ItemStack(HighlandsBlocks.cotton, 1, 0));
        }
    ...
    public static void setFireProperties(Block block, int encouragement, int flammability) {
        if (block != null) Blocks.fire.setFireInfo(block, encouragement, flammability);
    }
