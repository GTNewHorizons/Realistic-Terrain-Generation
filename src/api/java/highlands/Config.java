...
public class Config {
    ...
    private static void addBiomeEntries(Configuration config) {
        alpsID = config.get(CATEGORY_BIOME_ID, "Alps ID", 200)
            .getInt();
        autumnForestID = config.get(CATEGORY_BIOME_ID, "Autumn Forest ID", 201)
            .getInt();
        badlandsID = config.get(CATEGORY_BIOME_ID, "Badlands ID", 202)
            .getInt();
        birchHillsID = config.get(CATEGORY_BIOME_ID, "Birch Hills ID", 203)
            .getInt();
        bogID = config.get(CATEGORY_BIOME_ID, "Bog ID", 204)
            .getInt();
        cliffsID = config.get(CATEGORY_BIOME_ID, "Cliffs ID", 205)
            .getInt();
        desertMountainsID = config.get(CATEGORY_BIOME_ID, "Desert Mountains ID", 206)
            .getInt();
        dunesID = config.get(CATEGORY_BIOME_ID, "Dunes ID", 207)
            .getInt();
        estuaryID = config.get(CATEGORY_BIOME_ID, "Estuary ID", 208)
            .getInt();
        flyingMountainsID = config.get(CATEGORY_BIOME_ID, "Flying Mountains ID", 209)
            .getInt();
        glacierID = config.get(CATEGORY_BIOME_ID, "Glacier ID", 210)
            .getInt();
        highlandsbID = config.get(CATEGORY_BIOME_ID, "Highlands ID", 211)
            .getInt();
        lowlandsID = config.get(CATEGORY_BIOME_ID, "Lowlands ID", 212)
            .getInt();
        meadowID = config.get(CATEGORY_BIOME_ID, "Meadow ID", 213)
            .getInt();
        outbackID = config.get(CATEGORY_BIOME_ID, "Outback ID", 214)
            .getInt();
        pinelandsID = config.get(CATEGORY_BIOME_ID, "Pinelands ID", 215)
            .getInt();
        rainforestID = config.get(CATEGORY_BIOME_ID, "Rainforest ID", 216)
            .getInt();
        redwoodForestID = config.get(CATEGORY_BIOME_ID, "Redwood Forest ID", 217)
            .getInt();
        rockMountainsID = config.get(CATEGORY_BIOME_ID, "Rock Mountains ID", 218)
            .getInt();
        sahelID = config.get(CATEGORY_BIOME_ID, "Sahel ID", 219)
            .getInt();
        savannahID = config.get(CATEGORY_BIOME_ID, "Savannah ID", 220)
            .getInt();
        steppeID = config.get(CATEGORY_BIOME_ID, "Steppe ID", 221)
            .getInt();
        snowMountainsID = config.get(CATEGORY_BIOME_ID, "Snow Mountains ID", 222)
            .getInt();
        tallPineForestID = config.get(CATEGORY_BIOME_ID, "Tall Pine Forest ID", 223)
            .getInt();
        tropicsID = config.get(CATEGORY_BIOME_ID, "Tropics ID", 224)
            .getInt();
        tropicalIslandsID = config.get(CATEGORY_BIOME_ID, "Tropical Islands ID", 225)
            .getInt();
        tundraID = config.get(CATEGORY_BIOME_ID, "Tundra ID", 226)
            .getInt();
        woodlandsID = config.get(CATEGORY_BIOME_ID, "Woodlands ID", 227)
            .getInt();
        woodlandMountainsID = config.get(CATEGORY_BIOME_ID, "Woodland Mountains ID", 228)
            .getInt();

        ocean2ID = config.get(CATEGORY_BIOME_ID, "Improved Oceans ID", 229)
            .getInt();
        ...
        desertIslandID = config.get(CATEGORY_SUBBIOME_ID, "DesertIsland ID", 230)
            .getInt();
        forestIslandID = config.get(CATEGORY_SUBBIOME_ID, "Forest Island ID", 231)
            .getInt();
        jungleIslandID = config.get(CATEGORY_SUBBIOME_ID, "Jungle Island ID", 232)
            .getInt();
        volcanoIslandID = config.get(CATEGORY_SUBBIOME_ID, "Volcano Island ID", 233)
            .getInt();
        snowIslandID = config.get(CATEGORY_SUBBIOME_ID, "Snow Island ID", 234)
            .getInt();
        rockIslandID = config.get(CATEGORY_SUBBIOME_ID, "Rock Island ID", 235)
            .getInt();
        windyIslandID = config.get(CATEGORY_SUBBIOME_ID, "Windy Island ID", 236)
            .getInt();
        lakeID = config.get(CATEGORY_SUBBIOME_ID, "Lake ID", 237)
            .getInt();
        baldHillID = config.get(CATEGORY_SUBBIOME_ID, "Bald Hill ID", 238)
            .getInt();
        mesaID = config.get(CATEGORY_SUBBIOME_ID, "Mesa ID", 239)
            .getInt();
        valleyID = config.get(CATEGORY_SUBBIOME_ID, "Valley ID", 240)
            .getInt();
        oasisID = config.get(CATEGORY_SUBBIOME_ID, "Oasis ID", 241)
            .getInt();
        canyonID = config.get(CATEGORY_SUBBIOME_ID, "Canyon ID", 242)
            .getInt();
        shrublandID = config.get(CATEGORY_SUBBIOME_ID, "Shrublands ID", 243)
            .getInt();
