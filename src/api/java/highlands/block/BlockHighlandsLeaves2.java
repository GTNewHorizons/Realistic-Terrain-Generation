...
public class BlockHighlandsLeaves2 extends BlockLeavesBase implements IShearable {
    ...
    private String[] treeNames = { "Hedge", "JapaneseMaple", };

    private int[] saplingRate = { 30, 20 };
    ...
    // return prod;
    // }
    // return Block.blocksList[ world.getBlockId(x,y,z) ].getBlockDropped(world, x,y,z, world.getBlockMetadata(x,y,z),
    // 0);
    // }
    //
    // @Override
