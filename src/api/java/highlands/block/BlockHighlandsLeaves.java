...
public class BlockHighlandsLeaves extends BlockLeavesBase implements IShearable {
    ...
    private String[] treeNames = { "Fir", "Acacia", "Poplar", "Redwood", "Eucalyptus", "GreatOak", "Beech", "DeadTree",
        "EvgBush", "DecBush", "Palm", "Ironwood", "Mangrove", "Ash", "AutumnYellow", "AutumnOrange", };

    private int[] saplingRate = { 30, 20, 20, 40, 20, 0, 0, 0, 0, 0, 12, 75, 15, 25, 20, 20 };
                        ...
                        for (i2 = -b0; i2 <= b0; ++i2) {
                            for (j2 = -b0; j2 <= b0; ++j2) {
                                ...
                                if (block != null
                                    ...
                                    if (block != null && block.isLeaves(par1World, par2 + l1, par3 + i2, par4 + j2)) {
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (par1World.canLightningStrikeAt(par2, par3 + 1, par4)
            && !par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4)
    ...
    public int quantityDropped(Random par1Random) {
        return par1Random.nextInt(saplingRate[treeType]) == 0 ? 1 : 0;// chance to drop sapling. Change for different
                                                                      // trees
    }
        ...
        if (!world.isRemote) {
            ...
            if (world.rand.nextInt(j1) == 0) {
                ...
                this.dropBlockAsItem(
                    ...
                    p_149690_3_,
                    p_149690_4_,
                    new ItemStack(item, 1, this.damageDropped(p_149690_5_)));
            }
    ...
    public IIcon getBlockTextureFromSideAndMetadata(int par1, int par2) {
        this.field_150121_P = Minecraft.getMinecraft()
