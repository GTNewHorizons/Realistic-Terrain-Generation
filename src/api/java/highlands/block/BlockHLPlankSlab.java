...
public class BlockHLPlankSlab extends BlockSlab {
    ...
    @Override
    public int onBlockPlaced(World world, int x, int y, int z, int metadata, float p_149660_6_, float p_149660_7_,
        float p_149660_8_, int p_149660_9_) {
        return this.field_150004_a ? p_149660_9_
            : (metadata != 0 && (metadata == 1 || (double) p_149660_7_ <= 0.5D) ? p_149660_9_ : p_149660_9_ | 8);
    }
}
