...
/**
 * Allows direct access to Extrabiome's biomes. This class' members will be populated during the @Init event. If a biome
 * is absent after the
...
public abstract class BiomeManager {
     ...
     * @param weight   the relative probabilty of picking this grass to generate. To establish a relative priority, some
     *                 function should be
     ...
     * @param weight  the relative probabilty of picking this tree to generate. To establish a relative priority, some
     *                function should be
     *                applied to the current total weight for a biome.
     */
